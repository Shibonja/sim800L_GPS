...
int InetGSM::httpPOST(const char* server, int port, const char* path, const char* parameters, char* result, int resultlength)
{
     ...
     gsm.SimpleWrite("X-ApiKey: 5377e30bd8b64f909f91568f6ce8d2b9\r\n");
     gsm.SimpleWrite("Cache-Control: no-cache\r\n");
     gsm.SimpleWrite("Content-Type: application/json\r\n");
     //gsm.SimpleWrite("X-ApiKey: 5377e30bd8b64f909f91568f6ce8d2b9\r\nContent-Type: application/json; charset=UTF-8\r\n");
     //gsm.SimpleWrite("Authorization: Basic c2lib25qaWMuaGFyaXNAZ21haWwuY29tOkZVTExIRDEwODA=\r\nCache-Control: no-cache\r\n");
